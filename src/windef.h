...
class window
{
 public:
  ...
  void set_render_loop_callback(void (*prfc)(window* pwin, void* pcmr, void* pmsh));

  void run_render_loop(void* pcmr, void* pmsh);
  ...
  void (*get_render_loop_callback(void))(window* pwin, void* pcmr, void* pmsh);
 ...
 private:
  ...
  void (*rendercallback)(window* pwin, void* pcmr, void* pmsh);
